...
- Dev v3.2: Se hacer correcciones a la introducción.

- Dev v3.3: Se crea la estructura del capítulo 3 "*Hybrid Tugboat*".

- Dev v3.4: Se agrega información respecto a los sistemas de potencia integrados y segregados, además de agregar una tabla comparativa de los sistemas de propulsión híbrido y serie.

- Dev v3.5: Se agrega información respecto a los sistemas de propulsión híbrido serie, específicamente sus dos variantes, "*Electric Shaft*" y "*DC-Link*", cada una con y sin opciones de almacenamiento.

- Dev v3.6: Se agrega información respecto a los sistemas de propulsión híbrido en paralelo, específicamente sus modos de oepración: PTI, PTO y PTH.

- **Dev v4:** Se realiza la primera versión del capítulo 3, relacionado a la descripción y funcionamiento del remolcador híbrido y las mejoras comparadas con el remolcador convencional. Esta versión es enviada a Marcelo Pérez para su revisión.


- Dev v4.1: Se agrega información sobre el dimensionamiento y los parámetros de diseño de la batería. Queda en consideración los criterios físicos de la embarcación, CAPEX, OPEX y ROI.

- **Dev v5:** Se realiza la primera versión del capítulo 4, relacionado a las comparaciones técnicas y económicas de las tecnologías de baterías para el diseño del banco de baterías. Esta versión es enviada a Marcelo Pérez para su revisión.

- **Dev v6:** Se entrega el documento completo para la revisión del comité evaluador y el profesor guía.

- **Dev v7:** Versión final del documento subido a la plataforma de biblioteca. Gracias y espero que este repositorio sea de ayuda para alguien en un futuro. No te rindas, puedes lograrlo.