...
nexttile
yyaxis right
bar(T,emm2,'FaceColor',[0.404, 0.431, 0.388]);
title ('Fuel consumption/generated emmisions for two maneuvers')
ylabel('Emissions [t co_2]','FontSize',11)
ylim([0 2.4])
yticks(0:0.3:2.4)
yyaxis left
%stem(T,rate_fuel2,'*');
ylabel('Fuel [L/h]','FontSize',11)
ylim([0 1800])
yticks(0:225:1800)
xticklabels({'8:00',' ','10:00',' ','12:00',' ','14:00',' ','16:00',' ','18:00'})
grid on
