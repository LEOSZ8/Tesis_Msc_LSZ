...
Percent_fuel1_emiss1= [0,39,0,0]; 
Percent_fuel2_emiss2= [13,26,0,0]; %PBatt [kW] = 15% Pnom 
Percent_fuel3_emiss3= [39,0,0,0];  %PBatt [kW] = 25% Pnom

p=[Percent_fuel1_emiss1;Percent_fuel2_emiss2;Percent_fuel3_emiss3];
x= ({'0% Pnom','15% Pnom','25% Pnom'});
yya=({' ','\bf 0kW - 1000kW \newline\newline           39%',' ',' '});
yyb=({'\bf Batt \newline      13% Saved','\bf 0kW - 1000kW \newline           26%',' ',' '});
yyc=({'\bf Batt \newline\newline      39% Saved',' ',' ',' '});
...
ylim([0 110])
yticks(0:10:100)
xlabel('Battery bank service power [%]','FontSize',12,'FontName','Times New Roman')
