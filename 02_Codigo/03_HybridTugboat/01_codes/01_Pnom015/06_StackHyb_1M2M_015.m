...
Percent_fuel1_emiss1= [20,42,38];
Percent_fuel2_emiss2= [6,19,75];
p=[Percent_fuel1_emiss1;Percent_fuel2_emiss2];

yya=({'\bf 0kW - 1000kW \newline\newline            20%','\bf 1000kW - 2000kW \newline\newline\newline               42%','\bf  2000kW - 3650kW \newline\newline\newline               38%'});
yyb=({'\bf 0kW - 1000kW  6%','\bf 1000kW - 2000kW \newline\newline               19%','\bf 2000kW - 3650kW \newline\newline\newline               75%'});
labels1_1=yya(1,1);
labels1_2=yya(1,2);
labels1_3=yya(1,3);
labels2_1=yyb(1,1);
