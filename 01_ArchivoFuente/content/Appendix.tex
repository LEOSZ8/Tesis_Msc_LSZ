...
With these transfer functions, current and voltage controllers can be designed to control the input current to the converter and the voltage balance at the output.
