...
In a hybrid series configuration, the mechanical connection between the internal combustion engine and the propeller shaft is completely decoupled. The vessel is propelled exclusively by electric motors \cite{VolvoPenta}.
