...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/LengthOverall.pdf}
    \caption{Length Overall}
    \label{fig:LengthOverallTug}
\end{figure}

The overall length is measured from the bow to the stern of the vessel in a straight line, excluding bowsprits, rudders, outboard motors and their supports, cranks and other accessories, fixed elements, and extensions \cite{wleonline}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/Beam.pdf}
    \caption{Beam Tug}
    \label{fig:BeamTug}
\end{figure}

A tugboat's beam is the distance between the two widest points of the hull \cite{HZContainer}. It is usually measured at the waterline, although other specifications such as maximum beam or deck beam may be used. Beam is a critical dimension in naval architecture, affecting the stability, maneuverability, and overall performance of the vessel \cite{DiscoverBoating}.

\subsubsection{c) Draught}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/Draught.pdf}
    \caption{Draught Tug}
    \label{fig:DraughtTug}
\end{figure}

Draught or Draft is the vertical distance from the moulded base line amidships to the actual waterline \cite{Wartsila}.

\subsubsection{d) Depth}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/Depth.pdf}
    \caption{Depth Tug}
    \label{fig:DepthTug}
\end{figure}

Depth or molded depth of a vessel is measured at the center of the length, from the top of the keel to the highest continuous deck on the side \cite{Wartsila}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/GrossTonnage.png}
...
\begin{itemize}
	\item Under vessel measurement rules of various nations, the Panama Canal and the Suez Canal gross tonnage is a measure of the internal volume of space within a vessel in which 1 ton is equivalent to 2.83 cub m or 100 cub ft.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/NetTonnage.pdf}
    \caption{Net Tonnage Tug}
    \label{fig:NetTonnageTug}
\end{figure}

Net Tonnage (NT) is focuses on the space available for cargo \cite{Wartsila} \cite{chinarubberfender}.
