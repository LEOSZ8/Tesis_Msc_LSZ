...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{images/chapter02/MainEngine.pdf}
    \caption{Main Engine}
    \label{fig:MainEngine}
\end{figure}


\subsubsection{a) Standby}

\subsubsection{b) Mission Critical}

\subsubsection{c) Prime}

\subsubsection{d) Continuous}
