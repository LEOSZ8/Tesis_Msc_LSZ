...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{images/chapter02/dimensions_tug.pdf}
    \caption{dimensions Tug}
    \label{fig:dimensions_tug}
\end{figure}
...
GT measures how much weight the ship can safely carry, including cargo, fuel, water, crew, and supplies \cite{chinarubberfender}. It’s about the ship’s “carrying capacity”, not its size. DWT refers to weight and indicates how much the ship can safely carry. It is expressed in long tons of 2,240 pounds (1,016.0469088 kilograms) \cite{Britannica}.
